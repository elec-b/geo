...
## 1. ¿Es viable "GeoExpert"?

**NO. Inviable.**

Ya existe **"GeoExpert - Learn Geography"** (Sierra Chica Software SL, Málaga):
- App Store iOS (id: 519549026), Google Play, Amazon Appstore
- Activamente mantenida (última actualización: marzo 2026)
- Rating 4.5/5, ~220K-500K usuarios totales
- Variantes: GeoExpert+, GeoExpert Lt, GeoExpert Spain/Canada/Sweden
- Common law trademark rights por uso continuo desde 2012
- Apple tiene formulario de disputa de nombres; precedente: "Pomodoro One" forzado a renombrarse "Tomato One"

Además, el nombre tiene debilidades intrínsecas:
- Patrón "Geo+X" saturadísimo (GeoGuessr, GeoQuiz, GeoChallenge, GeoGrid, GeoTouch...)
- "Expert" transmite conocimiento, no exploración ni diversión
- No evoca la identidad de la app (globo 3D, pasaporte, gamificación)
...
| App | Descargas | Enfoque | Diferenciador |
|-----|-----------|---------|---------------|
| **GeoGuessr** | ~600K/mes | Street View quiz | Inmersivo, comunidad enorme, competitivo |
| **Seterra** (de GeoGuessr) | 2.1M totales | Quiz 2D clásico | 400+ quizzes, 40 idiomas, 20+ años |
| **StudyGe** | 4.5-6M totales | Quiz + mapa interactivo | Progresión por países, diseño limpio |
| **Globe Guess 3D** | Nuevo | Quiz con globo 3D | 195 países, 22 idiomas |
| **Globle** | Viral (web) | Adivinar país diario | Estilo Wordle, globo 3D |
| **GeoExpert** (Sierra Chica) | ~220-500K totales | Quiz educativo | Usado en escuelas |

### Nuestro diferenciador real

El globo 3D ya no es único (Globe Guess 3D, Globle). Lo que nos diferencia es:
- **Gamificación con pasaporte y sellos** (metáfora de progresión)
- **Algoritmo adaptativo** (rachas, etapas, avance colectivo)
- **Estética premium** (dark mode, sin anuncios)
- **32 idiomas** con datos verificados

---

## 3. Patrones de naming en el nicho

| Patrón | Ejemplos | Saturación |
|--------|----------|------------|
| Geo+X | GeoGuessr, GeoExpert, GeoChallenge | **Altísima** — evitar |
| Globe/Earth+X | Globle, Globe Guess 3D, EarthChasers | **Alta** — evitar |
| World+X | Worldle, World Geography Quiz | **Alta** — evitar |
| Inventados/portmanteau | Seterra, StudyGe | **Baja** — los más exitosos a largo plazo |
| Latín/griego | — | **Baja** — buena diferenciación, pero verificar conflictos |

**Tendencias 2025-2026**: Nombres cortos (1-2 palabras), compatibles con voice search (Siri/Assistant), Apple Intelligence usa búsqueda semántica (no hace falta "geo" en el nombre para rankear).
...
## 5. Evaluación de "GeoExpert" vs criterios

| Criterio | GeoExpert | Candidatos viables |
|----------|-----------|-------------------|
| Disponibilidad | ❌ Cogido | ⚠️ Parcialmente libres |
| Memorabilidad | 6/10 Genérico | 7-8/10 |
| Multi-idioma | 7/10 | 7-9/10 |
| Diferenciación | 3/10 "Geo+X" saturado | 7-9/10 |
| Evocación (pasaporte, globo, exploración) | 4/10 | 7-9/10 |
| Escalabilidad | 4/10 | 5-9/10 |
