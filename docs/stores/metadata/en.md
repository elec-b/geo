# Exploris — App Store / Google Play metadata (en)

## iOS Name (≤30)
Exploris

## Android Title (≤30)
Exploris: Geography · 19/30 chars
...
Explore — spin the globe, tap countries and discover info cards with flag, capital, population, area, currency, languages, HDI and a direct link to Wikipedia.

Play — start with Adventure mode. The algorithm proposes questions adapted to your progress and combines different game types so you learn without getting bored.

Passport — earn stamps by completing tests with no mistakes. Climb from Tourist to Backpacker, and from Backpacker to Guide, on each continent. Your goal: fill the passport.

WHO IT'S FOR

Designed for kids and teenagers from 8 to 15, but so engaging it will hook adults curious about the world too.

DATA SOURCES

Verified public data from the United Nations, Natural Earth, the World Bank and Wikidata. The app silently checks for newer data in the background and updates automatically.

PRIVACY

Exploris does not collect any personal data. No accounts, no tracking, no ads. Your progress lives only on your device.
