...
- [ ] Clasificación por edad: 4+ (iOS) / Everyone (Android). Dos cuestionarios separados (Apple tiene el suyo propio en App Store Connect; Google usa IARC vía Play Console). NO categorizar como «directed to children» — evita Kids Category / Families Policy (incompatibles con el enlace a Wikipedia). Respuestas preparadas en `docs/stores/age-rating.md`; pendiente de verificar comportamiento del enlace Wikipedia en dispositivo y de transcribir a las consolas cuando existan los app records
