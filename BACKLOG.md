...
- [ ] **(check)** Ampliar cobertura de idiomas: tenemos 26, pero App Store soporta ~40 locales. Mini-spike para cruzar nuestros 26 idiomas vs. los disponibles en App Store y evaluar cuáles añadir. Candidatos conocidos: griego (~10M), filipino (~45M, aunque muchos usan inglés), danés, finés, eslovaco, croata, catalán. El pipeline ya funciona — el coste marginal por idioma es bajo.
